...
<div id="tooplate_header_wrapper">
    ...
    <div id="tooplate_header">
        ...
        <div id="tooplate_menu">
            ...
            <ul>
                <li><a href="landing.jsp" class="current">Home</a></li>
                <li><a href="post_login1.jsp">About Us</a></li>
                <li><a href="post_login2.jsp">Services</a></li>
                <li><a href="post_login3.jsp">Solutions</a></li>
                <li><a href="post_login4.jsp">Contact</a></li>
            </ul>    	
